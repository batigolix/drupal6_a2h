<?php
// $Id: template.php,v 1.1 2009/06/12 06:55:20 agileware Exp $
...
function paradise_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function paradise_menu_local_task($link, $active = FALSE) {
...
function paradise_breadcrumb($breadcrumb) {
...
function paradise_comment_wrapper($content, $type = null) {
  static $node_type;
  if (isset($type)) {
    $node_type = $type;
  }
...
function paradise_menu_local_tasks() {
  $output = '';
 ...
 * @ingroup themeable
 */
function paradise_button($element) {
...
*/
function paradise_img_assist_page($content, $attributes = NULL) {
